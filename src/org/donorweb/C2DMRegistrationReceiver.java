...
public class C2DMRegistrationReceiver extends BroadcastReceiver {
	...
	private void saveRegistrationId(Context context, String registrationId) {
		...
		edit.putString(Constants.C2DM_AUTH, registrationId);
		edit.commit();
	}
	...
	public void sendRegistrationIdToServer(Context context, String deviceId,
			String registrationId) {
		Log.d("C@DM ID", "Device and registration id" + deviceId + " -- "
				+ registrationId);
		SharedPreferences prefs = PreferenceManager
				.getDefaultSharedPreferences(context);
		Editor edit = prefs.edit();
		...
		HttpPost post = new HttpPost("http://visualizeincode.com/register");
		try {
